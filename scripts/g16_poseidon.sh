BUILD_DIR=./packages/circuits/build/g16/poseidon
CIRCUIT_NAME="poseidon"$1
PTAU_FILE=./packages/circuits/pot18_final.ptau

mkdir -p $BUILD_DIR
circom ./packages/circuits/poseidon/$CIRCUIT_NAME.circom --r1cs --wasm -o $BUILD_DIR
