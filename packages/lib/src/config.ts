export const DEFAULT_EFF_ECDSA_WITNESS_GEN_WASM =
  "https://storage.googleapis.com/personae-proving-keys/eff_ecdsa/eff_ecdsa.wasm";
export const DEFAULT_EFF_ECDSA_CIRCUIT =
  "https://storage.googleapis.com/personae-proving-keys/eff_ecdsa/eff_ecdsa.circuit";
...
export const DEFAULT_MEMBERSHIP_CIRCUIT =
  "https://storage.googleapis.com/personae-proving-keys/membership/membership.circuit";
